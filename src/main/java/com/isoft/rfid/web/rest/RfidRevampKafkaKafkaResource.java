...
import com.isoft.rfid.config.KafkaSseConsumer;
import com.isoft.rfid.config.KafkaSseProducer;
...
@RestController
@RequestMapping("/api/rfid-revamp-kafka-kafka")
public class RfidRevampKafkaKafkaResource {

    private final Logger log = LoggerFactory.getLogger(RfidRevampKafkaKafkaResource.class);
    ...
    public RfidRevampKafkaKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
